      ...
      for (HasWord word : originalSentence) {
        if (word instanceof Label) {
          ...
          if (newLabel instanceof HasWord) {
           ...
           // System.out.println("Hasword" + newLabel);
            //System.out.println("Has labeld");
  ...
  Tree getBestParse(boolean stripSubcat) {
    ...
    if (bparser != null && parseSucceeded) {
      ...
      return tree;
    	...
    	System.out.println("GetBestPCFG" + getBestPCFGParse());
      return getBestPCFGParse();     // In our case, this code is exectued.
  ...
  public List<ScoredObject<Tree>> getKBestParses(int k) {
    ...
    if (bparser != null && parseSucceeded) {
      ...
      return trees;
    	...
    	System.out.println("Get into PCFGParses");
